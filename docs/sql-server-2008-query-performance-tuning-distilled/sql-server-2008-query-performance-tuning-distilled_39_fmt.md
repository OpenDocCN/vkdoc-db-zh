...
![图 18-14](img/323849_5_En_18_Fig14_HTML.jpg)

图 18-14 扩展事件输出，显示表变量在解决重编译问题中的作用
...
![图 18-15](img/323849_5_En_18_Fig15_HTML.jpg)

图 18-15 使用 `WITH RECOMPILE` 不会改变相同的执行计划
...
要查看执行计划中的提示，只需查看 `SELECT` 算子的属性，如图 18-16 所示。

![图 18-16](img/323849_5_En_18_Fig16_HTML.jpg)

图 18-16 参数编译值与查询提示提供的值相匹配
...
![图 18-17](img/323849_5_En_18_Fig17_HTML.jpg)
