...
![图 10-10：Azure 虚拟机上 SQL Server 的 SQL 最佳实践评估结果截图。下方是两个饼图，分别显示所有问题的总数和按类别分类的问题。底部是两个表格。](img/525217_1_En_10_Fig10_HTML.png)
...
![图 10-11：SQL 最佳实践评估通知截图。下方是基本详细信息，其下是一个柱状图，右侧是 SQL 最佳实践评估的通知列表。](img/525217_1_En_10_Fig11_HTML.png)
