...
Listing 17-2 The InnoDB lock statistics for the test
```
...
Listing 17-3: The metadata locks found during the test
...
Listing 17-4 The InnoDB lock waits during the test
```
