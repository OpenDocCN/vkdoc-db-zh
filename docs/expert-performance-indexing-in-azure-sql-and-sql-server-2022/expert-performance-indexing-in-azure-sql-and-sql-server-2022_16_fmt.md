...
表 12-1 `sys.dm_db_missing_index_details` 中的列
...
表 12-2 `sys.dm_db_missing_index_columns` 中的列
...
表 12-3 `sys.dm_db_missing_index_groups` 中的列
...
表 12-4 `sys.dm_db_missing_index_group_stats` 中的列
...
![img/338675_4_En_12_Fig9_HTML.png](img/338675_4_En_12_Fig9_HTML.png)
