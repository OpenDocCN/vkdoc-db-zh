...
![img/338675_4_En_5_Fig1_HTML.png](img/338675_4_En_5_Fig1_HTML.png)
...
![img/338675_4_En_5_Fig2_HTML.png](img/338675_4_En_5_Fig2_HTML.png)
...
![img/338675_4_En_5_Fig18_HTML.png](img/338675_4_En_5_Fig18_HTML.png)
...
![img/338675_4_En_5_Fig19_HTML.png](img/338675_4_En_5_Fig19_HTML.png)

显示单例查找计数的查询表结果的屏幕截图，包含 3 行数据。列标题为表名、索引名称、行锁计数、行锁等待计数和行锁等待毫秒数。

**图 5-19** `singleton_lookup_count` 的查询结果
...
![img/338675_4_En_5_Fig20_HTML.png](img/338675_4_En_5_Fig20_HTML.png)

显示转发获取计数的查询表结果的屏幕截图，包含一行数据。列标题和值分别为：表名“转发记录”，索引名称“null”，以及转发获取计数 222。

**图 5-20** `forwarded_fetch_count` 的查询结果
...
**表 5-15** `sys.dm_db_index_operational_stats` 中的索引争用列
...
![img/338675_4_En_5_Fig24_HTML.png](img/338675_4_En_5_Fig24_HTML.png)
...
清单 5-33 查询 `sys.dm_db_index_operational_stats` 中的锁升级
...
表 5-16 `sys.dm_db_index_operational_stats` 中的闩锁活动列
...
![img/338675_4_En_5_Fig28_HTML.png](img/338675_4_En_5_Fig28_HTML.png)
...
![img/338675_4_En_5_Fig29_HTML.png](img/338675_4_En_5_Fig29_HTML.png)
...
**清单 5-43** 在 `sys.dm_db_index_operational_stats` 中查询页面压缩尝试情况
...
![img/338675_4_En_5_Fig30_HTML.png](img/338675_4_En_5_Fig30_HTML.png)
