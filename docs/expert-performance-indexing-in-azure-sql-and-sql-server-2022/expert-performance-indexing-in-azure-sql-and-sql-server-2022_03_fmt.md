...
![img/338675_4_En_3_Fig2_HTML.png](img/338675_4_En_3_Fig2_HTML.png)
...
![img/338675_4_En_3_Fig3_HTML.png](img/338675_4_En_3_Fig3_HTML.png)
...
![img/338675_4_En_3_Fig4_HTML.jpg](img/338675_4_En_3_Fig4_HTML.jpg)
...
![一张查询表结果的截图，显示 2 行数据。列标题为 file i d、page i d、page allocation、e x t size、object i d、index i d、partition number、partition i d、i am chain type 和 p f s bytes。表中的页面分配数为 9 和 4。](img/338675_4_En_3_Fig5_HTML.png)
...
清单 3-13 通过 `sys.dm_db_database_page_allocations` 获取的 `DBCC IND` 输出
...
![img/338675_4_En_3_Fig9_HTML.png](img/338675_4_En_3_Fig9_HTML.png)
...
![img/338675_4_En_3_Fig10_HTML.jpg](img/338675_4_En_3_Fig10_HTML.jpg)
