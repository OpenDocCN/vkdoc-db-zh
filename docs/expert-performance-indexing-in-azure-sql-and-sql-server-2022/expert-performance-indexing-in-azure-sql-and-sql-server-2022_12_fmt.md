...
```
清单 9-8 `CREATE FULLTEXT INDEX` 语句
...
```
清单 9-9 使用 `CONTAINS` 查询特定单词

图 9-2 显示了查询的执行计划。

![img/338675_4_En_9_Fig2_HTML.jpg](img/338675_4_En_9_Fig2_HTML.jpg)

图 9-2 `CONTAINS` 和全文索引使用的执行计划
...
```
代码清单 9-11 使用 `FULLTEXTCATALOGPROPERTY` 返回目录的填充状态
...
![img/338675_4_En_9_Fig4_HTML.png](img/338675_4_En_9_Fig4_HTML.png)
