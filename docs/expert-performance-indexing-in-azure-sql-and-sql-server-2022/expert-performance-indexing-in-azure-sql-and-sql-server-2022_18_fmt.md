...
![图 13-20](img/338675_4_En_13_Fig20_HTML.png)

*图 13-20：未利用索引交叉模式时的执行计划*

![图 13-19](img/338675_4_En_13_Fig19_HTML.png)

*图 13-19：未利用索引交叉模式时的统计信息 I/O 结果*
...
![图 13-21](img/338675_4_En_13_Fig21_HTML.png)

*图 13-21：带键查找的索引查找 vs. 使用索引交叉模式的两个索引查找*
...
![图 13-23](img/338675_4_En_13_Fig23_HTML.png)

*图 13-23：索引交叉模式的执行计划*

![图 13-22](img/338675_4_En_13_Fig22_HTML.png)

*图 13-22：索引交叉模式的统计信息 I/O 结果*
...
![img/338675_4_En_13_Fig35_HTML.png](img/338675_4_En_13_Fig35_HTML.png)
...
![img/338675_4_En_13_Fig34_HTML.png](img/338675_4_En_13_Fig34_HTML.png)
...
“筛选索引”模式，顾名思义，使用了 SQL Server 中的筛选索引功能。使用筛选索引时，会在非聚集索引中添加一个`WHERE`子句，以减少索引中包含的行数。通过仅包含匹配`WHERE`子句过滤条件的行，查询引擎在构建执行计划时只需考虑这些行；此外，扫描行范围的成本也低于索引包含所有行的情况。
...
![img/338675_4_En_13_Fig37_HTML.png](img/338675_4_En_13_Fig37_HTML.png)
...
![img/338675_4_En_13_Fig36_HTML.png](img/338675_4_En_13_Fig36_HTML.png)
...
![图 13-50 计算 JSON 列的执行计划](img/338675_4_En_13_Fig50_HTML.png)

![图 13-49 计算 JSON 列的统计 I/O 结果](img/338675_4_En_13_Fig49_HTML.png)
...
![图 13-52 计算并索引后的 JSON 列的执行计划](img/338675_4_En_13_Fig52_HTML.png)

![图 13-51 计算并索引后的 JSON 列的统计 I/O 结果](img/338675_4_En_13_Fig51_HTML.png)
