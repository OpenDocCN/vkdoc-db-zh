...
**清单 11-26：声明 `PropertyGrid`、`ExecuteCatalogPackageTask` 和 `Container` 成员**

`GeneralView` 应如图 11-35 所示：

![../images/449652_2_En_11_Chapter/449652_2_En_11_Fig35_HTML.jpg](img/449652_2_En_11_Fig35_HTML.jpg)

**图 11-35：`PropertyGrid`、`ExecuteCatalogPackageTask` 和 `Container` 成员**
...
清单 11-28 `InitializeComponent` 代码
...
图 11-37 向 `SettingsView` 添加 `InitializeComponent` 方法
