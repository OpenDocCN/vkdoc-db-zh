...
图 8-4 将 Class1 重命名为 ExecuteCatalogPackageTaskUI
...
图 8-10 错误列表显示 IDtsTaskUI 实现所需的方法
...
图 8-12 添加对 System.Windows.Forms 的引用
...
图 8-13 在 ExecuteCatalogPackageTaskUI.cs 类中使用 System.Windows.Forms
...
图 8-14 向 ExecuteCatalogPackageTaskUI.cs 类添加构造函数
...
清单 8-7 添加 Initialize 方法

`ExecuteCatalogPackageTaskUI` 类现在应显示为图 8-18 所示：

![图 8-18 添加 Initialize 方法](img/449652_2_En_8_Fig18_HTML.jpg)
...
![图 8-19 实现 IDtsTaskUI.Delete](img/449652_2_En_8_Fig19_HTML.jpg)

请注意，类声明 `public class ExecuteCatalogPackageTaskUI : IDtsTaskUI` 中 `IDtsTaskUI` 部分下方的波浪线已经消失，因为我们已经完成了所需接口成员的实现。

`GetView()` 方法包含波浪线。我们将在开始编写 `ExecuteCatalogPackageTaskUIForm` 的代码时解决此错误。
...
![图 8-20 添加标签和文本框](img/449652_2_En_8_Fig20_HTML.jpg)

为 Folder、Project 和 Package 属性添加标签和文本框控件，如图 8-21 所示：

![图 8-21 为 Folder、Project 和 Package 属性添加控件](img/449652_2_En_8_Fig21_HTML.jpg)

将新的文本框分别命名为 `txtFolder`、`txtProject` 和 `txtPackage`。

接下来，添加一个名为 `btnDone` 的按钮，并将其 `Text` 属性设置为“完成”，如图 8-22 所示：

![图 8-22 添加完成按钮](img/449652_2_En_8_Fig22_HTML.jpg)

最后，将 `btnDone` 的 `DialogResult` 属性更改为“OK”，如图 8-23 所示：

![图 8-23 更改完成按钮的 DialogResult 属性](img/449652_2_En_8_Fig23_HTML.jpg)
...
![图 8-24 将导入语句添加到 ExecuteCatalogPackageTaskUIForm 类](img/449652_2_En_8_Fig24_HTML.jpg)
...
![图 8-25 声明 TaskHost 变量](img/449652_2_En_8_Fig25_HTML.jpg)
...
![图 8-26 添加 ServerName 属性的值](img/449652_2_En_8_Fig26_HTML.jpg)
