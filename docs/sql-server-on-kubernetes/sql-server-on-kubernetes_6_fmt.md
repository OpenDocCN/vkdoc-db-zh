...
我们的日志聚合系统现已准备就绪。打开 Web 浏览器并导航到 `http://control:30445/`。
...
这些数据可以通过多种方式进行筛选和分析。要了解更多关于 Kibana 的信息，我们建议您查看 `www.elastic.co/kibana`。
