...
你也可以通过找到应用委托，然后访问栈中的某个对象来获取 Core Data 栈。这破坏了封装性，因为你正在窥视应用委托的内部。不过，你会在各种地方找到一些示例代码是这样做的，如果你只是偶尔——比如仅一次——需要访问栈，那么这样做也可以提出一个（较弱）的理由。以下是这种获取栈方式的代码。
...
# NSFetchedResultsController 的使用
...
![图 12-1. 从第 9 章的数据库开始](img/index-145_1.jpg)
