...
MongoDB 数据库中的每个对象都包含一个惟一的标识符，用于将该对象与其他所有对象区分开来。这个标识符称为`_id`键，它会自动添加到您在集合中创建的每个文档中。
...
**表 3-1. MongoDB Sample Databases Covered in This Book**
