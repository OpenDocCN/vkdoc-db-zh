...
# SQL Server Profiler 与 TRACEWRITE 等待类型
...
图 12-9. SQL Server 2012 安装程序中的“管理工具 - 完整版”功能
...
图 12-10 新建 SQL Server Profiler 跟踪
...
图 12-11 SQL Server Profiler 默认事件选择
...
图 12-12 选择了 `SQL:BatchCompleted` 事件
