...
图 10-9 主副本和辅助副本均无活动期间的 `HADR_SYNC_COMMIT` 等待信息
...
# 扩展存储过程与 PREEMPTIVE_OS_GETPROCADDRESS 等待类型
...
![图 11-18 执行扩展存储过程](img/340881_2_En_11_Fig18_HTML.jpg)
...
![图 11-19 master 数据库中的扩展存储过程选集](img/340881_2_En_11_Fig19_HTML.jpg)
...
![图 11-20 PREEMPTIVE_OS_GETPROCADDRESS 等待](img/340881_2_En_11_Fig20_HTML.jpg)
