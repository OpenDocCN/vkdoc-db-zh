...
清单 6-2 测量即时文件初始化对 `ASYNC_IO_COMPLETION` 等待的影响
...
图 6-10 修改查询后的 `ASYNC_NETWORK_IO` 等待时间
...
**Listing 6-8** 针对 AdventureWorks 数据库的排序查询
...
图 6-23：已授予工作区内存 (KB) Perfmon 计数器
