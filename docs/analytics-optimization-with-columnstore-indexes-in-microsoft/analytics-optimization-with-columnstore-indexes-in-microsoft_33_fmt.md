...
图 14-6 `Invoice Date Key`列在行组内的重叠值列表
...
代码清单 14-4 用于测试列存储索引中数据有序程度的样本日期

图 14-7 中的结果提供了每个日期的行数。

![](img/521866_1_En_14_Fig7_HTML.jpg)

图 14-7 用于测试列存储数据顺序有效性的样本日期列表
...
![img/521866_1_En_14_Fig8_HTML.jpg](img/521866_1_En_14_Fig8_HTML.jpg)
