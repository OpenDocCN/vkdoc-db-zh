...
![图 18-1 本地数据分类](img/480547_2_En_18_Fig1_HTML.jpg)
...
![图 18-4 可用的敏感度标签](img/480547_2_En_18_Fig4_HTML.jpg)

一旦确认了信息类型和敏感度标签，您可以选择表中左侧的复选框来标记任意多列进行更新。图 18-5 显示了为 `dbo.Customer.Address` 列选中的复选框。

![图 18-5：选择对特定列进行数据分类](img/480547_2_En_18_Fig5_HTML.jpg)
...
![图 18-6：查看已分类的数据](img/480547_2_En_18_Fig6_HTML.jpg)
...
![图 18-7：打开添加数据分类的窗口](img/480547_2_En_18_Fig7_HTML.jpg)
...
![图 18-8：向分类添加列](img/480547_2_En_18_Fig8_HTML.jpg)
...
![图 18-9：SQL 数据分类报告](img/480547_2_En_18_Fig9_HTML.jpg)
...
![图 18-10：在列属性中查看敏感度](img/480547_2_En_18_Fig10_HTML.jpg)
...
![img/480547_2_En_18_Fig14_HTML.jpg](img/480547_2_En_18_Fig14_HTML.jpg)
...
![img/480547_2_En_18_Fig15_HTML.jpg](img/480547_2_En_18_Fig15_HTML.jpg)
...
在清单 18-4 中，您指定了一个历史表及其名称。如果您没有指定名称，SQL Server 仍然会创建一个历史表。该表是创建可更新 ledger 表时隐式创建的。创建可更新 ledger 表的代码与清单 18-18 中的 T-SQL 类似。查询的最后几行是创建可更新 ledger 表所需的 T-SQL 代码。相同的命令 `LEDGER = ON` 启用了 ledger 功能。`SYSTEM_VERSIONING = (HISTORY_TABLE = dbo.ApplicatinRuleHistory)` 创建了将用于记录 ledger 历史的表。清单 18-23 包含查找创建可更新 ledger 表时所创建对象的 T-SQL 代码。
