...
**Listing 17-32: Creating Check Constraints on the Non-Partitioned Table**
...
**Listing 17-33: Partition Switch Out Last Month’s Customer Orders**
...
ALTER TABLE dbo.CustomerOrderActive
DROP CONSTRAINT CK_CustomerOrderActive_MaxDateCreated;
ALTER TABLE dbo.CustomerOrderActive
...
**Listing 17-34: Updating Check Constraints on dbo.CustomerOrderActive**
...
**Listing 17-35: Partitioned View for Recent Orders, Current Month, and Past Three Months**
...
**Listing 17-36: Partitioned View for All Orders**
