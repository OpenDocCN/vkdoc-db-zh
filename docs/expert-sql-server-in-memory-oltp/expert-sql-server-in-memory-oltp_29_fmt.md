...
代码清单 10-10. 朴素日志开销：获取事务日志和检查点文件的大小
...
代码清单 10-13. 将多个操作组合到单个 `ALTER TABLE` 语句中
