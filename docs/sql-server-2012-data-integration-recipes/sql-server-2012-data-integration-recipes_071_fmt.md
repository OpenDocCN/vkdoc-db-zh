...
2.  右键单击“连接管理器”选项卡。选择“新建连接”，然后选择“WMI”，如图 6-27 所示。

    ![9781430247913_Fig06-27.jpg](img/9781430247913_Fig06-27.jpg)

    图 6-27. 添加 WMI 连接管理器

3.  单击“添加”。输入连接管理器的名称，输入服务器名称（除非默认的 `localhost` 就是你希望查询的），并选中“使用 Windows 身份验证”（同样，除非你需要以特定用户身份登录）。此时应该会出现一个类似图 6-28 的对话框。
