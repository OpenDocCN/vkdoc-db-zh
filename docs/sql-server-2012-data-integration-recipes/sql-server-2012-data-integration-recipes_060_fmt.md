...
4.  单击“连接到 Oracle”工具栏按钮。输入 Oracle 连接信息。你应该会看到类似图 4-9 的内容。
...
6.  单击“连接到 SQL Server”。输入你的 SQL Server 连接参数。在“SQL Server 元数据资源管理器”窗格中，选择目标数据库。你应该会看到一个类似于图 4-10 的屏幕。
