...
![img/527021_1_En_3_Fig9_HTML.png](img/527021_1_En_3_Fig9_HTML.png)
...
清单 3-13 `FIRST_VALUE()` 和 `LAST_VALUE()` 函数实际应用
...
清单 3-19 用于预加载的 `YearlySummaryReport` 表
...
![图 3-21 比较估计查询计划](img/527021_1_En_3_Fig21_HTML.png)
