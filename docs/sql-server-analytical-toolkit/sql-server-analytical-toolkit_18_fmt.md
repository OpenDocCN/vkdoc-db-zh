...
![图 11-1. 库存数据库概念模型](img/527021_1_En_11_Fig1_HTML.png)
...
![图 11-2. 库存数据仓库概念模型](img/527021_1_En_11_Fig2_HTML.jpg)
...
![图 11-3. 创建项目](img/527021_1_En_11_Fig3_HTML.jpg)
...
![图 11-4. 添加连接管理器](img/527021_1_En_11_Fig4_HTML.jpg)
...
![图 11-5. 配置连接管理器](img/527021_1_En_11_Fig5_HTML.jpg)
...
![img/527021_1_En_11_Fig31_SQL.png](img/527021_1_En_11_Fig31_SQL.png)
...
![img/527021_1_En_11_Fig32_HTML.png](img/527021_1_En_11_Fig32_HTML.png)
...
![img/527021_1_En_11_Fig33_HTML.png](img/527021_1_En_11_Fig33_HTML.png)
...
![图 11-31：平均值、方差和标准差报告](img/527021_1_En_11_Fig34_HTML.png)
...
清单 11-10 用于 SSIS 执行 TSQL 任务的 TSQL 脚本
...
> 提示：在创建或重建索引；执行`INSERT`、`UPDATE`或`DELETE`行操作；或`TRUNCATE`表时，更新统计信息始终是一项良好的策略。
