...
![图 7-4 查找中位数](img/335106_2_En_7_Fig4_HTML.jpg)
...
![图 7-5 行数为奇数时，两个函数返回相同的值](img/335106_2_En_7_Fig5_HTML.jpg)
...
![图 7-6 前 25% 位置的分数](img/335106_2_En_7_Fig6_HTML.jpg)
...
代码清单 7-8 仅使用 SQL Server 2005 功能计算 `PERCENTILE_DISC`
