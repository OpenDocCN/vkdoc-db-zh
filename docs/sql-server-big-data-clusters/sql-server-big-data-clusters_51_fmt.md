...
*清单 8-10：通过 `azdata` 检索应用 URL 和端口号*
...
*图 8-6：`predictiris` 应用的 `app describe` 命令输出*
...
图 8-10 `swagger.json` 文件的 Host 属性
...
清单 8-11 `predictiris` 应用的输入参数（JSON）
...
图 8-11 调用 `predictiris` 应用的 REST API 的正文
...
图 8-12 包含每种鸢尾花植物物种概率的 REST API 响应正文
