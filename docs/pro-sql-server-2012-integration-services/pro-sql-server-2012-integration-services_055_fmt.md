...
**注意：** Excel 源和 Excel 目标配适器使用 Microsoft OLE DB Provider for Jet 4.0 和 Excel 索引顺序访问方法 (ISAM) 驱动程序来读写 Excel 电子表格。请记住，此驱动程序仅提供非常有限的 SQL 风格查询语法子集，并且不支持许多您可能习惯的 T-SQL 功能。
...
##### 图 7-33. 在 Excel 目标编辑器中配置 Excel 目标配适配器
