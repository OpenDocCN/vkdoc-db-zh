...
![图 26-2. 参数嗅探：为 `@Country='Canada'` 缓存的计划](img/index-508_1.jpg)
...
![图 26-3. 参数嗅探：语句级重编译](img/index-509_1.jpg)

![图 26-3. 参数嗅探：语句级重编译](img/index-509_2.jpg)
...
![图 26-4. 参数嗅探：`OPTIMIZE FOR` 提示](img/index-510_1.jpg)

![图 26-4. 参数嗅探：`OPTIMIZE FOR` 提示](img/index-510_2.jpg)
