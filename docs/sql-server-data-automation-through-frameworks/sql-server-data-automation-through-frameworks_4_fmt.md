...
清单 10-3 幂等 T-SQL 创建 `log.UpdateApplicationInstanceStatus` 存储过程
...
*清单 11-4. 更新`ReportAndFail.dtsx`应用程序包的`FailApplicationOnPackageFailure`位*
...
*图 11-34. `ReportAndFail.dtsx`应用程序包的`FailApplicationOnPackageFailure`位已更新*
...
*图 11-35. 容错功能在行动中；一个应用程序包的失败不会停止应用程序执行*
