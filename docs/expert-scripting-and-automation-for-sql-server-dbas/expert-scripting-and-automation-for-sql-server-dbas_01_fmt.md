...
![img/395785_2_En_1_Fig1_HTML.jpg](img/395785_2_En_1_Fig1_HTML.jpg)
...
代码清单 1-14 使用 FOR XML AUTO

此查询返回的 XML 片段可以在代码清单 1-15 中看到。

```xml
代码清单 1-15 使用 FOR XML AUTO 结果提取会话信息
```
...
代码清单 1-17 使用 FOR XML PATH 创建根节点并命名`<row>`元素
