...
Listing 9-3 Rebooting the Cluster from Complete Loss
...
Listing 9-4 Reestablishing the Cluster after Dissolving
...
**Listing 9-5** Example Logical Backup (`mysqlpump`)
...
Listing 9-6 Restoring a Logical Backup (`mysqlsh`)
...
学习如何部署和管理 InnoDB 集群的最大障碍之一是将集群视为一组相似的服务器，而不是一组单独的服务器。对于那些来自传统 MySQL 主/从复制的人来说，这是特别重要的一课。过去，人们通常认为拓扑中的服务器是必须单独使用的个体。这是因为我们有通过中继日志处理来自单个主服务器的更改的机器，而这些服务器(从服务器)从不互相沟通。
...
Listing 9-7 Displaying the SSL Variables
...
Listing 9-8 Example Cluster Setup with SSL = Required and Whitelist Defined
...
Listing 9-9: Displaying the Group Replication Variables
...
router_id=4
bootstrap_server_addresses=mysql://cluster-rpi1:3306,mysql://cluster-rpi2:3306,mysql://cluster-rpi3:3306,mysql://cluster-rpi4:3306
