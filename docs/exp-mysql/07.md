...
***[清单 7-10](#_list10) 。*??【UDF _ example . def】源代码**
...
***[清单 7-20](#_list20) 。*??【SHOW DISK _ USAGE 命令对 sql_cmd.h 文件的修改**
...
***[清单 7-21](#_list21) 。*向 sql_yacc.yy 文件添加令牌**
...
***[清单 7-25](#_list25) 。*??【show _ disk _ usage _ command】实现**
...
***[清单 7-27](#_list27) 。*??【最终展示 _ 磁盘 _ 用法 _ 命令】源代码**
...
***[清单 7-29](#_list29) 。*?? 对 enum_schema_tables 枚举的修改**
...
***[清单 7-31](#_list31) 。*??【磁盘使用模式表】新字段信息结构**
...
***[清单 7-32](#_list32) 。*?? 对 schema_tables 数组的修改**
...
***[清单 7-33](#_list33) 。*??【fill _ disk _ usage】函数实现**
