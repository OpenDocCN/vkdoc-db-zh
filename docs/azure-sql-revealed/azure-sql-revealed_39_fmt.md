...
请记住，你还可以像 Davide Mauri 在这篇博文中展示的那样，将混合搜索的结果与 RAG 模式结合使用：[`https://devblogs.microsoft.com/azure-sql/rag-with-azure-sql`](https://devblogs.microsoft.com/azure-sql/rag-with-azure-sql)。
