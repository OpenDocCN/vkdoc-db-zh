...
![图 8-24](img/496204_2_En_8_Fig24_HTML.jpg)

**图 8-24** 在 Azure 门户中配置和管理故障转移组
...
![图 8-25](img/496204_2_En_8_Fig25_HTML.jpg)

**图 8-25** 使用托管实例链接进行灾难恢复
...
图 8-35 使用业务关键层的 Azure SQL 数据库的副本状态
...
图 8-39 使用 `活动日志` 跟踪手动故障转移

注意：对于 Azure SQL 托管实例和数据库部署，`资源运行状况` 都是在数据库级别报告的。
