...
清单 12-2 使用 `sys.dm_exec_query_stats`
...
图 12-5 `Sys.dm_exec_query_stats` 结果
...
你可以从`https://docs.microsoft.com/en-us/sql/relational-databases/system-dynamic-management-views/sys-dm-exec-session-wait-stats-transact-sql`获取关于`sys.dm_exec_session_wait_stats`视图的更多信息。你可以在`https://docs.microsoft.com/en-us/sql/relational-databases/extended-events/extended-events`阅读关于扩展事件的内容。
