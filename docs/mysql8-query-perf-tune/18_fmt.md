...
清单 18-13 在`REPEATABLE READ`事务隔离级别持有的锁。
...
表 18-3 `performance_schema.metadata_locks` 表中的对象类型
...
[`https://bugs.mysql.com/bug.php?id=44884`](https://bugs.mysql.com/bug.php%253Fid%253D44884)
