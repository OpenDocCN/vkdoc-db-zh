...
代码清单 8-7 第 3 至 12 行、第 14 和 15 行的提示看起来几乎像是 SQL 语句中常见的内嵌提示。它们控制连接顺序、连接方法和访问方法。我说几乎，是因为它们包含了全局提示语法和完全限定的对象别名，这些虽然合法，但在 SQL 语句的源代码中很少见到。我们将在本章后面更详细地探讨全局提示。
