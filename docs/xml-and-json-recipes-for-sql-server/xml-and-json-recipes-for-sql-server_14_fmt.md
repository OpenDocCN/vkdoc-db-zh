...
0-1 Miles
示例 6-2. 展示带有 currency 属性的 YearlyIncome 元素
...
代码清单 6-4. 使用 XQuery 根据值过滤 XML 实例

图 6-2 展示了查询结果。

![A435478_1_En_6_Fig2_HTML.jpg](img/A435478_1_En_6_Fig2_HTML.jpg)

图 6-2. 返回 `TotalPurchaceYTD` 大于 `9000.00` 的行
