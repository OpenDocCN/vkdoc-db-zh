...
清单 8-8. 带有`INCLUDE_NULL_VALUES`选项的`FOR JSON`子句
...
清单 8-11. 显示`WITHOUT_ARRAY_WRAPPER`选项
...
清单 8-14. 显示带有顶层键元素`"Customers"`的 JSON 输出
...
清单 8-15. 显示`ROOT`与`WITHOUT_ARRAY_WRAPPER`选项组合时的错误消息
...
**Listing 8-17.** Showing JSON output
