...
您还可以使用其他一些有趣的`kubectl`命令来检查 Pod 和 SQL Server 的状态。要查看选项的完整列表，您可以运行命令`kubectl help`，或者查看[`kubectl`参考文档](https://kubernetes.io/zh-cn/docs/reference/kubectl/overview)。
