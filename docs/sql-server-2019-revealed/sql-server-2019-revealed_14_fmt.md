...
我们引入了 `mssql-server-polybase` 软件包来为 SQL Server on Linux 启用 PolyBase。你可以在 `https://docs.microsoft.com/en-us/sql/relational-databases/polybase/polybase-linux-setup` 阅读完整的部署步骤。
