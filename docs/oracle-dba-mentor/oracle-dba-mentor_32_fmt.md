...
报告由 Oracle 数据库预升级信息工具版本 `18.0.0.0.0` 于 `2018-09-14T14:21:32` 生成。
升级目标版本：`18.0.0.0.0`
...
| Oracle 组件 | 升级操作 | 当前状态 |
| :--- | :--- | :--- |
| Oracle Server | [待升级] | `VALID` |
| JServer JAVA Virtual Machine | [待升级] | `VALID` |
| Oracle XDK for Java | [待升级] | `VALID` |
| Oracle Workspace Manager | [待升级] | `VALID` |
| Oracle XML Database | [待升级] | `VALID` |
| Oracle Java Packages | [待升级] | `VALID` |

清单 18-4：预升级日志文件介绍性信息
